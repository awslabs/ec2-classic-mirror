...
//   untagged for ClassicLink Mirroring.
...
exports.describeSecurityGroupPairs = function(callback) {
    ...
    // classiclinkmirror:mirroredFromClassicSecurityGroupId, meaning that
    // we have been managing their rules as part of a pair
    ...
    return this.ec2DescribeSecurityGroups(classicDescribeParams)
        .then(function(data) {
            ...
            // to the classiclinkmirror:ClassicSecurityGroupId tag we put
            // on it); if there is no match, then its Classic counterpart

...
// instances that are members of ClassicMirror-managed Classic Security
// Groups get linked to the corresponding VPC Security Groups.
...
exports.linkInstances = function(securityGroupPairs, callback) {
    ...
    return ec2DescribeInstances(describeInstancesParams).then(function(data) {
        ...
        // Describe instances ClassicLinked to our set of ClassicMirror-
        // managed VPC Security Groups.
...
// Given maps of ClassicMirror-managed Classic instances and the set of
// Classic instances currently linked to ClassicMirror-managed VPC
